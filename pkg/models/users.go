...
type User struct {
	...
	Hashword  []byte    `boil:"hashword" json:"hashword" toml:"hashword" yaml:"hashword"`
...
var UserWhere = struct {
	...
	Hashword:  whereHelper__byte{field: "\"users\".\"hashword\""},
...
var (
	userAllColumns            = []string{"id", "name", "email", "hashword", "active", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"id", "name", "email", "hashword", "active"}
