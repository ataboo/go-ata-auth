...
var SessionWhere = struct {
	...
	EndedAt:      whereHelpernull_Time{field: "\"sessions\".\"ended_at\""},
...
var (
	sessionAllColumns            = []string{"id", "user_id", "access_token", "refresh_token", "ended_at", "expires_at", "created_at", "updated_at"}
	sessionColumnsWithoutDefault = []string{"id", "user_id", "access_token", "refresh_token", "ended_at", "expires_at"}
	sessionColumnsWithDefault    = []string{"created_at", "updated_at"}
